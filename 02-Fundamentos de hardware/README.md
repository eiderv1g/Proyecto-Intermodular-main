...
# CYBERFORGE - FUNDAMENTOS DEL HARDWARE

**Equipo**: Sergio Gallardo Marchal, Miriam Ocaña Pérez-Cerdá, Antonio José Rossi Bersabé.

---

En el módulo de Fundamentos del Hardware hemos propuesto una serie de apartados sobre la organización del equipo necesario para nuestra empresa, en el que incluimos desde los componentes más básicos para formar los ordenadores de formación hasta los servidores o puntos de accesos para nuestra base de datos. 

---

# Índice del Proyecto

## 1. Ánalisis completo del Hardware
En este apartado hay una revisión del equipo necesario y la descripción de componentes claves.
...
## 3. Sumario
Resumen con las conclusiones finales sobre las decisiones tomadas.